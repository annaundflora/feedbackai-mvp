-- backend/migrations/002_create_clustering_tables.sql
-- Migration: Create clustering tables
-- Date: 2026-02-28
-- Description: Erstellt alle Tabellen fuer das LLM Interview Clustering Feature
